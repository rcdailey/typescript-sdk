...
- [`941226e`](https://github.com/modelcontextprotocol/typescript-sdk/commit/941226e0775ffcba1942d4fee2a175eebc57f2bd) Thanks [@rcdailey](https://github.com/rcdailey)! - Add optional `keepAliveInterval` to `WebStandardStreamableHTTPServerTransportOptions` that sends periodic SSE
  comments on the standalone GET stream to prevent reverse proxy idle timeout disconnections.
